...
**外延的記法**（roster notation）では，集合のすべての要素を列挙する．

例えば，$$10$$より小さい正の奇数全体の集合は$${1, 3, 5, 7, 9}$$，四季の集合は$${\text{春}, \text{夏}, \text{秋}, \text{冬}}$$と表される．

集合が多くの要素を持つ場合は，省略記号（$$\ldots$$）を使って表すことができる．

例えば，$$1$$から$$100$$までの自然数全体の集合は$${1, 2, 3, \ldots, 100}$$，自然数全体の集合$$\mathbb{N}$$は$${1, 2, 3, \ldots}$$と表される．
